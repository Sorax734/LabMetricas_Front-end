    ...
    const onChangeStatus = async () => {
        try {
            ...
            if (response.type === "SUCCESS"){
                addToast({
                    title: `Se ${data.status === "activo" ? "inhabilitó" : "habilitó"} el mantenimiento / calibración: ${data.code}`,
                ...
                addToast({
                    title: `No se ${data.status === "activo" ? "inhabilitó" : "habilitó"} el mantenimiento / calibración: ${data.code}`,
                    color: "danger",
    ...
    if (data){
        return (
            <ChangeStatusModal
                ...
                title={`¿Desea ${data.status === "activo" ? "inhabilitar" : "habilitar"} el mantenimiento / calibración: ${data.code}?`}
                description={data.status === "activo" ? "Al inhabilitar el mantenimiento / calibración, no estará disponible, pero podrá ser habilitado nuevamente en cualquier momento." : "Al habilitar el mantenimiento / calibración, se restablecerá su disponibilidad con normalidad."}
            >
                <PrimaryButton
